...
const DeviceDataPanel: React.FC = () => {
  ...
  const handleSetClosedLoopControlEnabled = async () => {
    await handleRequest(
      "/closed_loop_control",
      { enabled: closedLoopControlEnabled },
      "Closed loop control updated"
    );
  };
    ...
    <div className="panel">
      ...
      <div className="fieldGroup">
        ...
        <div className="buttons">
          <button onClick={() => handleGetSerialNumber()} disabled={isDisabled}>
            Read
          </button>
          <button onClick={() => setShowSnModal(true)} disabled={isDisabled}>
            Update Serial Number
          </button>
        </div>
      </div>

      {/* Display the serial number write status */}
      <div className="fieldGroup">
      ...
      <div className="fieldGroup">
        ...
        />
        <div className="buttons">
          <button onClick={handleSetSamplesAmount} disabled={isDisabled}>
            Set
          </button>
          <button
      ...
      <div className="fieldGroup">
        ...
        />
        <div className="buttons">
          <button onClick={handleSetAdcSamplesAmount} disabled={isDisabled}>
            Set
          </button>
          <button
      ...
      <div className="fieldGroup">
        ...
        <div className="buttons">
          ...
          <button onClick={() => handleGetShuntRes()} disabled={isDisabled}>
            Get
          </button>
        </div>
      </div>
      ...
      <div className="fieldGroup">
        ...
        <div className="buttons">
          ...
          <button onClick={() => handleGetVoltageGain()} disabled={isDisabled}>
            Get
          </button>
        </div>
      </div>
      ...
      <div className="fieldGroup">
        ...
        <div className="buttons">
          ...
          <button onClick={() => handleGetCurrentGain()} disabled={isDisabled}>
            Get
          </button>
        </div>
      </div>
      ...
      <div className="fieldGroup">
        ...
        <input
          ...
          onChange={(e) => setPhaseCurrMaxDistance(Number(e.target.value))}
          disabled={isDisabled}
        />
        <div className="buttons">
          <button onClick={handleSetPhaseCurrMaxDistance} disabled={isDisabled}>
            Set
          </button>
          <button
      ...
      <div className="fieldGroup">
        ...
        <input
          ...
          onChange={(e) => setAutoFreqSweepWidth(Number(e.target.value))}
          disabled={isDisabled}
        />
        <div className="buttons">
          <button onClick={handleSetAutoFreqSweepWidth} disabled={isDisabled}>
            Set
          </button>
          <button
      ...
      <div className="fieldGroup">
        ...
        <input
          type="checkbox"
          checked={closedLoopControlEnabled}
          onChange={(e) => setClosedLoopControlEnabled(e.target.checked)}
          disabled={isDisabled}
        />
        <div className="buttons">
          <button
            onClick={handleSetClosedLoopControlEnabled}
            disabled={isDisabled}
          >
            Set
          </button>
      ...
      <div className="fieldGroup">
        ...
        <input
          ...
          onChange={(e) => setClosedLoopControlPeriod(Number(e.target.value))}
          disabled={isDisabled}
        />
        <div className="buttons">
          <button
